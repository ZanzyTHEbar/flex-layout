...
export class TabNode extends Node implements IDraggable {
    ...
    private static _createAttributeDefinitions(): AttributeDefinitions {
        ...
        attributeDefinitions.add('tabsetclass', undefined).setType(Attribute.STRING)
        ...
        attributeDefinitions
            ...
            .setType(Attribute.BOOLEAN)
        attributeDefinitions.addInherited('class', 'tabclass').setType(Attribute.STRING)
        attributeDefinitions
            .addInherited('contentclass', 'tabContentclass')
    ...
    getclass() {
        return this._getAttr('class') as string | undefined
    }

    getContentclass() {
        return this._getAttr('contentclass') as string | undefined
    }

    getTabSetclass() {
        return this._getAttr('tabsetclass') as string | undefined
    }
