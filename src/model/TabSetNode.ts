...
export class TabSetNode extends Node implements IDraggable, IDropTarget {
    ...
    private static _createAttributeDefinitions(): AttributeDefinitions {
        ...
        attributeDefinitions.addInherited('classTabStrip', 'tabSetclassTabStrip')
        attributeDefinitions.addInherited('classHeader', 'tabSetclassHeader')
    ...
    getclassTabStrip() {
        return this._getAttr('classTabStrip') as string | undefined
    }

    getclassHeader() {
        return this._getAttr('classHeader') as string | undefined
    }
